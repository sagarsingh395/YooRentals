...
class AuthCheckFilter implements FilterInterface
{
    ...
    public function check_privilege()
    {
        ...
        $urlArr = [
            ...
            '/admin/add_user'       => [1, 2],
            '/admin/edit_user/*'    => [1, 3],
            '/admin/user_profile/*' => [1, 4],
            '/admin/user_delete/*'  => [1, 5],

            /**************User Group(Menu ID: 2)****************** */
            '/admin/user-group'     => [2, null],
            '/admin/add-group'      => [2, 2],
    ...
    //         /**************Users group****************** */
    //     } else if (url_is('/admin/user-group')) {
    //         return is_privilege(2);
    //     } else if (url_is('/admin/add-group')) {
    //         return is_privilege(2, 2);
    //     } else if (url_is('/admin/edit-group/*')) {
    //         return is_privilege(2, 3);
    //     } else if (url_is('/admin/delete-group/*')) {
