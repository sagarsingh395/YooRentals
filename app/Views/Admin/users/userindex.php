        ...
        <div class="d-flex align-items-center gap-2 flex-wrap">
            <form class="d-flex" style="max-width: 250px;">
                <div class="input-group input-group-sm">
                    <input type="text" id="searchInput" class="form-control border-start-0 border-end-0" placeholder=" Email / Phone">
            ...
            <nav aria-label="breadcrumb">
                <ul class="breadcrumb">
                    <li class="breadcrumb-item active" aria-current="page">
                        <a href="<?= base_url('admin/add_user') ?>" class="btn btn-primary"><i class="bi bi-person-plus-fill"></i> Add User</a>
                    </li>
                </ul>
            </nav>
        </div>
